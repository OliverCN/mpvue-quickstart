export default {
    ...
    mutations: {
      setNavBarHeight: (state, { navigationHeight, statusBarHeight, fontSizeSetting, screenHeight, windowHeight }) => {
        state.sysInfo = {
          statusBarHeight,
          navigationHeight,
          windowHeight,
      ...
      setMessageList: (state, {list, isCompleted, conversationID}) => {
        let conversation = state.conversations.find(c => c.conversationID === conversationID)
